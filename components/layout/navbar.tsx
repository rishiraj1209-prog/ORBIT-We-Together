...
export default function Navbar() {
  return (
    <motion.nav
      ...
      <div className="mx-auto flex h-20 w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-16">
        <Link href="/" className="flex items-center gap-3">
          ...
          <span className="text-2xl font-black text-white sm:text-3xl">Orbit</span>
        </Link>
